...
class HandshakeAscension {
  ...
  private val key_constant_2 = java.util.HexFormat.of.parseHex("b6eb6241b5829b689f07c91f5731ba1bbb671c3fa2f7001c2249e3fa52dd8702")
  private val key_constant_3 = java.util.HexFormat.of.parseHex("4f4b")
  ...
  val random_nonce = { val result = Array.fill[Byte](12)(0); scala.util.Random.nextBytes(result); result }

  val key_derived = derive_key(key_constant_2, key_shared, "derived".getBytes("utf-8"), 32)
  val key_session = derive_key(key_constant_2, key_shared, "session".getBytes("utf-8"), 40)

  val proof_2 = calculate_proof(key_derived, key_constant_3)
